...
for i in range(envProcesses):
    ...
    if headless:
        os.system(
            "gnome-terminal -- ./UEBinary/{projectName}.sh -RenderOffscreen -windowed -NoVSync".format(
        ...
        windowY = 1000
        os.system(
            "gnome-terminal -- ./UEBinary/{projectName}.sh -windowed -WinX={WinX} -WinY={WinY} -NoVSync".format(
...
for i in range(envProcesses):
    ...
    os.system(
        "gnome-terminal -- python PyClient.py {UE_port} {UE_Address} {storage_port}".format(

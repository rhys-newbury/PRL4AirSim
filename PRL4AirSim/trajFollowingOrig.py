...
def main(args):
    ...
    ######### GENERATE TRAJECTORY #########
    trajectoryFollower = airsimUtils.TrajectoryFollower(trajectoryPoints, 2.0)
    ...
    if args.useAirsim:
        ...
        while flying:
            ...
            # Execute the action
            client.moveByVelocityAsync(velocity[0], velocity[1], velocity[2], actionTime * 2, yaw_mode=airsim.YawMode(True, yawRate * 180 / math.pi), vehicle_name='Drone0')

...
def main(args):
    ...
    if args.useAirsim:
        ...
        try:
            unrealEngineProcess = subprocess.Popen([args.unrealPath, "-WINDOWED -ResX=640 -ResY=480"], stdout=subprocess.DEVNULL)
    ...
    if args.useAirsim:
        ...
        while flying:
            ...
            print(currentVelocity, velocity)
